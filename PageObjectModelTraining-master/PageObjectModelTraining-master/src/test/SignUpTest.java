...
public class SignUpTest {
	...
	public void signUpContentCheck() {
		...
		System.out.println(stackMatter);
		
		header = new Headers(driver);
		header.navigateToSignUp();
		
		signuppage = new SignupPage(driver);
		String signupTitle = signuppage.getTitle();
		String signupURL = signuppage.getCurrentURL();
		String signupMatter = signuppage.getMatter();
